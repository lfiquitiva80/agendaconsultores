...
class cerrados extends Mailable
{
     ...
     */
     ...
     {
         return $this->markdown('emails.cerrados.cerrados')->subject('Cerrado Satisfatoriamente '.$this->store->clientes->nombre_cliente." , Checklist ".$this->store->checklista->descripcion.' #'.$this->store->id)->with([
