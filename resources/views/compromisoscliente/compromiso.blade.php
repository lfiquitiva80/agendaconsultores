...
<h4><b><center>LOS COMPROMISOS QUE TIENE EL CLIENTE</h4></b></center>
...
<td><a href="{{ $url = route('compromisoscliente.index') }}" class="btn btn-primary"><i class="fa fa-calendar-check-o" aria-hidden="true"></i> listar todos los Compromisos</a></td>
