<div class="modal fade" id="crear_encabezado_imp_iva">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                {!! Form::open(['route' => 'encabezado_imp_iva.store', 'method'=>'POST','id'=>'FormCreateencabezado_imp_ivas', 'enctype' => 'multipart/form-data']) !!}
...
{!! Form::date('fecha_auditoria_encabezado_imp_iva', null,['class' => 'form-control', 'placeholder' => 'fecha_auditoria_encabezado_imp_iva','name'=>'fecha_auditoria_encabezado_imp_iva','required']) !!}
