<div class="modal fade" id="crear_encabezado_dev_iva">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title">ENCABEZADO DEVOLUCION IVA</h4>
            </div>
            <div class="modal-body">
                ...
                {!! Form::open(['route' => 'encabezado_dev_iva.store', 'method'=>'POST','id'=>'FormCreateencabezado_dev_ivas', 'enctype' => 'multipart/form-data']) !!}
                ...
                <div class="form-group">
                    ...
                    {!! Form::select('auditor', $auditor, null, ['class' => 'form-control', 'placeholder' => 'Seleccione el Auditor... ','name'=>'auditor','required']) !!} 
