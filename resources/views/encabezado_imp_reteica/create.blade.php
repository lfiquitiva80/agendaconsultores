<div class="modal fade" id="crear_encabezado_imp_reteica">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                {!! Form::open(['route' => 'encabezado_imp_reteica.store', 'method'=>'POST','id'=>'FormCreateencabezado_imp_reteicas', 'enctype' => 'multipart/form-data']) !!}
...
{!! Form::date('fecha_auditoria_encabezado_imp_reteica', null,['class' => 'form-control', 'placeholder' => 'fecha_auditoria_encabezado_imp_reteica','name'=>'fecha_auditoria_encabezado_imp_reteica','required']) !!}
