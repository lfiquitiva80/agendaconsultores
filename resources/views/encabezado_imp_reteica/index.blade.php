...
<h4><b><center>REGISTROS DE encabezado_imp_reteica</h4></b></center>
...
<th>fecha_elaboracion</th> -->
  ...
  @foreach($encabezado_imp_reteica as $row)
    <tr>
         ...
         <td>
              <a class="btn bg-navy btn-flat margin" href="{{ $url = route('detalle_imp_reteica.edit', $row->id) }}" role="button"><i class="fa fa-list-alt" aria-hidden="true"></i> Detalle imp reteica</a>  
          </td>

          <td><a data-toggle="modal" data-target="#editar_encabezado_imp_reteica" 
          data-id="{{$row->id}}"
