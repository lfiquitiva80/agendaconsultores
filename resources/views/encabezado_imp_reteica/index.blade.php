...
<div class="container">
{!! Form::open(['route' => 'encabezado_imp_reteica.index', 'method'=>'GET', 'Class'=>'navbar-form navbar-right']) !!}
...
<a class="btn btn-info" data-toggle="modal" href='#crear_encabezado_imp_reteica'><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Crear encabezado_imp_reteica</a>

  @include('encabezado_imp_reteica.create')

  @include('encabezado_imp_reteica.edit')
...
<th>fecha_elaboracion</th> -->
  ...
  @foreach($encabezado_imp_reteica as $row)
    <tr>
 ...
 <?php $files3 = Storage::disk('public')->allFiles($row->ubicacion_archivos);
          ...
          <!--<td>{{$row->fecha_auditoria_encabezado_imp_reteica}}</td>
          <td>{{$row->fecha_elaboracion}}</td> -->

         <td>
              <a class="btn btn-default" href="{{ $url = route('detalle_imp_reteica.edit', $row->id) }}" role="button"><i class="fa fa-list-alt" aria-hidden="true"></i> detalle_imp_reteica</a>  
          </td>

          <td><a data-toggle="modal" data-target="#editar_encabezado_imp_reteica1" 
          data-id="{{$row->id}}"
          ...
          class="btn btn-success"><i class="fa fa-pencil" aria-hidden="true"></i></a></td>
            ...
            <td>@include('encabezado_imp_reteica.destroy')</td>
...
<center>{{ $encabezado_imp_reteica->links() }}</center>
...
{!! Form::close() !!}
    ...
    @include('encabezado_imp_reteica.auditoriaedit')
...
<th>fecha_elaboracion</th> -->
 ...
 <?php $files3 = Storage::disk('public')->allFiles($row->ubicacion_archivos);
         ...
         <td>
          ...
          @else
          <td><a data-toggle="modal" data-target="#editar_encabezado_imp_reteica22" 
          data-id="{{$row->id}}"
          data-responsable="{{$row->responsable}}"
          data-cliente="{{$row->cliente}}"
          data-audito="{{$row->audito}}"
...
{!! Form::close() !!}
 ...
 @include('encabezado_imp_reteica.cerradosedit')
...
<td>@php $usuario = App\User::find($row->responsable); echo $usuario->name; @endphp</td>
 ...
 <?php $files3 = Storage::disk('public')->allFiles($row->ubicacion_archivos);
         ...
         <td>
          ...
          @else
            <td><a data-toggle="modal" data-target="#editar_encabezado_imp_reteica3" 
          data-id="{{$row->id}}"
          data-responsable="{{$row->responsable}}"
          data-cliente="{{$row->cliente}}"
          data-audito="{{$row->audito}}"
