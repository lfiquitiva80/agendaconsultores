...
<div class="container">
{!! Form::open(['route' => 'encabezado_imp_ica.index', 'method'=>'GET', 'Class'=>'navbar-form navbar-right']) !!}
...
<a class="btn btn-info" data-toggle="modal" href='#crear_encabezado_imp_ica'><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Crear encabezado_imp_ica</a>

  @include('encabezado_imp_ica.create')

  @include('encabezado_imp_ica.edit')
...
<th>ubicacion_archivos</th>
<th>fecha_auditoria_encabezado_imp_ica</th>
<th>fecha_elaboracion</th> -->
  ...
  @foreach($encabezado_imp_ica as $row)
    <tr>
...
<?php $files3 = Storage::disk('public')->allFiles($row->ubicacion_archivos);
          ...
          <!--<td>{{$row->fecha_auditoria_encabezado_imp_ica}}</td>
          <td>{{$row->fecha_elaboracion}}</td> -->

         <td>
              <a class="btn btn-default" href="{{ $url = route('detalle_imp_ica.edit', $row->id) }}" role="button"><i class="fa fa-list-alt" aria-hidden="true"></i> Detalle Ica</a>
          </td>

          <td><a data-toggle="modal" data-target="#editar_encabezado_imp_ica1"
          data-id="{{$row->id}}"
          ...
          class="btn btn-success"><i class="fa fa-pencil" aria-hidden="true"></i></a></td>
            ...
            <td>@include('encabezado_imp_ica.destroy')</td>
...
<center>{{ $encabezado_imp_ica->links() }}</center>
...
{!! Form::close() !!}
    ...
    @include('encabezado_imp_ica.auditoriaedit')
    ...
    <tr>
      ...
      <?php $files3 = Storage::disk('public')->allFiles($row->ubicacion_archivos);
         ...
         <td>
          ...
          @else
          <td><a data-toggle="modal" data-target="#editar_encabezado_imp_ica22"
          data-id="{{$row->id}}"
          data-responsable="{{$row->responsable}}"
          data-cliente="{{$row->cliente}}"
          data-audito="{{$row->audito}}"
...
{!! Form::close() !!}
 ...
 @include('encabezado_imp_ica.cerradosedit')
...
<?php $files3 = Storage::disk('public')->allFiles($row->ubicacion_archivos);
         ...
         <td>
            ...
            <td><a data-toggle="modal" data-target="#editar_encabezado_imp_ica3"
          data-id="{{$row->id}}"
          data-responsable="{{$row->responsable}}"
          data-cliente="{{$row->cliente}}"
          data-audito="{{$row->audito}}"
