...
<h4><b><center>REGISTROS DE encabezado_imp_ica</h4></b></center>
...
<th>fecha_elaboracion</th> -->
  ...
  @foreach($encabezado_imp_ica as $row)
    <tr>
         ...
         <td>
              <a class="btn bg-navy btn-flat margin" href="{{ $url = route('detalle_imp_ica.edit', $row->id) }}" role="button"><i class="fa fa-list-alt" aria-hidden="true"></i> Detalle Impuesto Ica</a>  
          </td>

          <td><a data-toggle="modal" data-target="#editar_encabezado_imp_ica" 
          data-id="{{$row->id}}"
