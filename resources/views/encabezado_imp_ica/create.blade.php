<div class="modal fade" id="crear_encabezado_imp_ica">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                {!! Form::open(['route' => 'encabezado_imp_ica.store', 'method'=>'POST','id'=>'FormCreateencabezado_imp_icas', 'enctype' => 'multipart/form-data']) !!}
...
{!! Form::date('fecha_auditoria_encabezado_imp_ica', null,['class' => 'form-control', 'placeholder' => 'fecha_auditoria_encabezado_imp_ica','name'=>'fecha_auditoria_encabezado_imp_ica','required']) !!}
