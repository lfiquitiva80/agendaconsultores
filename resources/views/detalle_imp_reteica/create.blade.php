<div class="modal fade" id="crear_detalle_imp_reteica">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title">CREAR detalle_imp_reteica</h4>
            </div>
            <div class="modal-body">
                ...
                {!! Form::open(['route' => 'detalle_imp_reteica.store', 'method'=>'POST','id'=>'FormCreatedetalle_imp_reteicas']) !!}
