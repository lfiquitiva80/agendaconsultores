<div class="modal fade" id="crear_encabezado_informe">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                {!! Form::open(['route' => 'encabezado_informe.store', 'method'=>'POST','id'=>'FormCreateencabezado_informes', 'enctype' => 'multipart/form-data']) !!}
...
{!! Form::date('fecha_auditoria_encabezado_informe', null,['class' => 'form-control', 'placeholder' => 'fecha_auditoria_encabezado_informe','name'=>'fecha_auditoria_encabezado_informe','required']) !!}
