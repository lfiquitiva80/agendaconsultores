...
<h4><b><center>REGISTROS DE encabezado_informe</h4></b></center>
...
<th>fecha_elaboracion</th> -->
  ...
  @foreach($encabezado_informe as $row)
    <tr>
         ...
         <td>
              <a class="btn bg-navy btn-flat margin" href="{{ $url = route('detalle_informe.edit', $row->id) }}" role="button"><i class="fa fa-list-alt" aria-hidden="true"></i> Detalle Informes</a>  
          </td>

          <td><a data-toggle="modal" data-target="#editar_encabezado_informe" 
          data-id="{{$row->id}}"
