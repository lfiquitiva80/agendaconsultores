<div class="modal fade" id="crear_encabezado_imp_retencion">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title">CREAR ENCABEZADO Y DETALLE</h4>
            </div>
            <div class="modal-body">
                ...
                {!! Form::open(['route' => 'encabezado_imp_retencion.store', 'method'=>'POST','id'=>'FormCreateencabezado_imp_retencions', 'enctype' => 'multipart/form-data']) !!}
...
{!! Form::date('fecha_auditoria_encabezado_imp_retencion', null,['class' => 'form-control', 'placeholder' => 'fecha_auditoria_encabezado_imp_retencion','name'=>'fecha_auditoria_encabezado_imp_retencion','required']) !!}
