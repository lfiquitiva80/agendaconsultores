...
<?php $files3 = Storage::disk('public')->allFiles($row->ubicacion_archivos);
         ...
         <td>
              <a class="btn btn-default" href="{{ $url = route('detalle_imp_retencion.edit', $row->id) }}" role="button"><i class="fa fa-list-alt" aria-hidden="true"></i> detalle_imp_retencion</a>
          </td>

          <td><a data-toggle="modal" data-target="#editar_encabezado_imp_retencion1"
          data-id="{{$row->id}}"
...
{!! Form::close() !!}
    ...
    @include('encabezado_imp_retencion.auditoriaedit')
...
<?php $files3 = Storage::disk('public')->allFiles($row->ubicacion_archivos);
         ...
         <td>
          ...
          @else
          <td><a data-toggle="modal" data-target="#editar_encabezado_imp_retencion22"
          data-id="{{$row->id}}"
          data-responsable="{{$row->responsable}}"
          data-cliente="{{$row->cliente}}"
          data-audito="{{$row->audito}}"
...
{!! Form::close() !!}
 ...
 @include('encabezado_imp_retencion.cerradosedit')
...
<?php $files3 = Storage::disk('public')->allFiles($row->ubicacion_archivos);
         ...
         <td>
            ...
            <td><a data-toggle="modal" data-target="#editar_encabezado_imp_retencion3"
          data-id="{{$row->id}}"
          data-responsable="{{$row->responsable}}"
          data-cliente="{{$row->cliente}}"
          data-audito="{{$row->audito}}"
