...
<div class="modal fade" id="editar_detalle_imp_retencion">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="" action="{{route('detalle_imp_retencion.update', 'id' )}}"   method="post" id="FormEditdetalle_imp_retencions">
