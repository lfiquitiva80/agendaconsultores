...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="{{ route('plantilla_checklist.index') }}"><i class="fa fa-bell" aria-hidden="true"></i><span> Plantilla checklist</span></a></li>

            <li><a href="{{ route('checklist.index') }}"><i class="fa fa-certificate" aria-hidden="true"></i><span> Checklist</span></a></li>
